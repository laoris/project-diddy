...
namespace SeniorProject
{
    class SquareGuy1 : NPC
    {
        ...
        public SquareGuy1(): base(COLLISION_OFFSET, NPC_SPEED, AGGRO_RADIUS, INIT_X_POS, INIT_Y_POS, IMAGE_NAME, MAX_HP, RESPAWN_TIME, ATTACK_RANGE, ATTACK_COOLDOWN, STRENGTH, MAX_SPIRIT, EXPERIENCE)
        {
