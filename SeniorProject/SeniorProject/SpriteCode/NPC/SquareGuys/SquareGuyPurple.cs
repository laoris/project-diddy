...
namespace SeniorProject
{
    class SquareGuyPurple : NPC
    {
        ...
        private const int INIT_X_POS = 1300;    //the initial x position
        private const int INIT_Y_POS = 1300;     //the initial y position
        private const String IMAGE_NAME = "SquareGuyPurple";      //the image file for the sprite
        private const int MAX_HP = 140;              //the dudes hp
        ...
        private const float STRENGTH = 14;               //NPC strength - directly related to his damage
        private const int EXPERIENCE = 15;
        private const Boolean SPIRIT_ATTACK = true;

        public SquareGuyPurple()
